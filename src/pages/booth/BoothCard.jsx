...
const BoothCard = ({ dataBooth }) => {
  const { boothName, description, features } = dataBooth;
  return (
    <div>
      <div className="bg-white p-5 rounded-lg h-[420px] mt-10 mb-10 flex flex-col">
        ...
        <div className=" flex-1">
          ...
          <div>
            ...
            <p className=" text-slate-800 flex">
              <BsCheckLg className="text-lg font-semibold" /> {features[1]}
            </p>
            <p className=" text-slate-800 flex ">
              <BsCheckLg className="text-lg font-semibold" /> {features[2]}
            </p>
          </div>
        </div>
